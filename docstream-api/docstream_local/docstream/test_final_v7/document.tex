...
\begin{figure}[h!]
    \centering
    \rule{0.8\columnwidth}{0.3\textheight} % Placeholder for Fig. 2
...
\begin{figure}[h!]
    \centering
    \rule{0.8\columnwidth}{0.3\textheight} % Placeholder for Fig. 3
...
\begin{figure}[h!]
    \centering
    \rule{0.8\columnwidth}{0.3\textheight} % Placeholder for Fig. 4
...
\begin{figure}[h!]
    \centering
    \rule{0.8\columnwidth}{0.3\textheight} % Placeholder for Fig. 5
    \caption{3D model rendering screen.}
    \label{fig:3d_model_rendering}
\end{figure}
