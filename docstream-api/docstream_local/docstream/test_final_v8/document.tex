...
\begin{figure}[htbp]
    \centering
    % Image for Login system screen would go here if provided.
...
\begin{figure}[htbp]
    \centering
    % Image for Sample products screen would go here if provided.
...
\begin{figure}[htbp]
    \centering
    % Image for 2D-to-3D model generation screen would go here if provided.
