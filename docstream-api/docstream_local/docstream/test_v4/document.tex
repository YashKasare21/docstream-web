...
\IEEEauthorblockA{\textsuperscript{1}Google Brain, \textsuperscript{2}Google Research, \textsuperscript{3}University of Toronto, \textsuperscript{4}Google Research\\
...
The Transformer uses multi-head attention in three different ways: in "encoder-decoder attention" layers, in self-attention layers in the encoder, and in self-attention layers in the decoder.
...
Deep-Att + PosUnk \cite{ref39} & & 39.2 & & 1.4 $\cdot 10^{20}$ \\
GNMT + RL \cite{ref38} & 24.6 & 39.92 & 2.3 $\cdot 10^{19}$ & 1.5 $\cdot 10^{20}$ \\
...
Residual Dropout We apply dropout \cite{ref33} to the output of each sub-layer, before it is added to the sub-layer input and normalized. In addition, we apply dropout to the sums of the embeddings and the positional encodings in both the encoder and decoder stacks. For the base model, we use a rate of $P_{drop} = 0.1$.

Label Smoothing During training, we employed label smoothing of value $\epsilon_{ls} = 0.1$ \cite{ref36}. This hurts perplexity, as the model learns to be more unsure, but improves accuracy and BLEU score.
...
\bibitem{ref10} Sepp Hochreiter and Jürgen Schmidhuber. Long short-term memory. Neural Computation, 9(8):1735–1780, 1997.
\bibitem{ref11} Andrew Senior, Gregor Heinrich, and Katrin Kirchhoff. 2018. arXiv preprint arXiv:1804.08210.
\bibitem{ref12} Ilya Sutskever, Oriol Vinyals, and Quoc V. Le. Sequence to sequence learning with neural networks. In Advances in Neural Information Processing Systems, pages 3104–3112, 2014.
\bibitem{ref18} Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Łukasz Kaiser, and Illia Polosukhin. Attention is all you need. arXiv preprint arXiv:1706.03762, 2017.
\bibitem{ref20} Diederik P. Kingma and Jimmy Ba. Adam: A method for stochastic optimization. arXiv preprint arXiv:1412.6980, 2014.
\bibitem{ref25} Mitchell P. Marcus, Mary Ann Marcinkiewicz, and Beatrice Santorini. Building a large annotated corpus of english: The penn treebank. Computational linguistics, 19(2):313–330, 1993.
\bibitem{ref29} Slav Petrov and Leon Barrett. 2006. arXiv preprint.
\bibitem{ref31} Rico Sennrich, Barry Haddow, and Alexandra Birch. 2015. arXiv preprint arXiv:1508.07909.
\bibitem{ref32} 2017. arXiv preprint arXiv:1703.03906.
\bibitem{ref33} Nitish Srivastava, Geoffrey Hinton, Alex Krizhevsky, Ilya Sutskever, and Ruslan Salakhutdinov. Dropout: A simple way to prevent neural networks from overfitting. Journal of Machine Learning Research, 15:1929–1958, 2014.
\bibitem{ref36} Christian Szegedy, Vincent Vanhoucke, Sergey Ioffe, Jon Shlens, and Zbigniew Wojna. Rethinking the inception architecture for computer vision. arXiv preprint arXiv:1512.00567, 2015.
\bibitem{ref37} Oriol Vinyals, Łukasz Kaiser, Terry Koo, Slav Petrov, Ilya Sutskever, and Geoffrey Hinton. Grammar as a foreign language. arXiv preprint arXiv:1412.7449, 2014.
\bibitem{ref38}
